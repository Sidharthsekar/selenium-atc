...
public class Categories extends BaseClass {
	...
	private static By lnkCategoryWomen = By.xpath("//div[@id='block_top_menu']//a[@title='Women']");
	
	private static By lnkCategorySummerDresses = By.xpath("//a[@title='Women']/following-sibling::ul//a[@title='Summer Dresses']");
